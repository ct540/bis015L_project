...
options(scipen=999)
=======
>>>>>>> e3ba4553e9e4626db4ac51847e92e0bce90e30e8
``` 
...
```{r}
<<<<<<< HEAD
final_disease_data$cases <- as.numeric(final_disease_data$cases) 
final_disease_data$disease <- as.numeric(final_disease_data$disease) 
##need to convert cases into a number 
```
...
<<<<<<< HEAD
  ...
  box(title = "Disease Abundance ", width = 8,
...
<<<<<<< HEAD
  ...
  ggplot(aes_string(x = "county", y="cases", fill="input$y")) + 
  geom_col()+
